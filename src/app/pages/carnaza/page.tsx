...
export default function Page() {
  ...
  const [cards, setCards] = useState(carnazaData);

  function handleSearch() {
    setCards(() =>
      carnazaData.filter((el) =>
...
function Main({
  ...
  const totalPages = Math.ceil(carnazaData.length / itemsPerPage);
