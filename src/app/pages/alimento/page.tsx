...
export default function Page() {
  ...
  const [cards, setCards] = useState(alimentoData);

  function handleSearch() {
    setCards(() =>
      alimentoData.filter((el: { name: string; description: string; price: number; imageUrl: StaticImageData }) =>
